		...
		<form action="business-join-pro" method="post" novalidate>
			<div class="form-group">
				<label for="businessId">사업자번호</label> <input type="text"
					id="businessId" name="businessId" placeholder="- 없이 입력하세요" required
					pattern="\d{1,10}">
			...
			<div class="form-group">
				<label for="salary">급여</label> <input type="number" id="salary"
					name="salary" placeholder="급여" required>
			</div>
			<div class="form-group">
				<label for="welfare">복리후생</label> <input type="text" id="welfare"
					name="welfare" placeholder="복리후생">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="type">유형</label> <select name="type">
					<option value="대기업">대기업</option>
					<option value="중견기업">중견기업</option>
					<option value="중소기업">중소기업</option>
				</select>
				<!--                 <input type="text" id="type" name="type" placeholder="유형"> -->
			</div>
			<div class="form-group">
				<label for="industry">산업</label> <input type="text" id="industry"
					name="industry" placeholder="산업">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="homepage">홈페이지</label> <input type="url" id="homepage"
					name="homepage" placeholder="홈페이지">
			</div>
