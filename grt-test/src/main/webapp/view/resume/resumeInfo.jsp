...
<body class="bg-gray-100" >
  <div class="container mx-auto p-6 bg-white shadow-md rounded-lg mt-10 container-fixed " style="max-width: 1000px;">
    <form method="post" name="resumeForm" action="insert-resume" enctype="multipart/form-data">
      ...
      <div class="flex flex-wrap mb-4">
        <div class="w-full md:w-1/3 px-2">
          ...
          <div class="image-upload-wrapper">
            <img id="profileImage" src="${pageContext.request.contextPath}/img/resume/${resume.profileImage}" alt="Profile Image">
            <input name="profileImage" value="${resume.profileImage}"  type="file" id="imageUpload" accept="image/*" onchange="loadFile(event)">
          </div>
        ...
        <div class="w-full md:w-2/3 px-2">
          <div class="mb-4">
            ...
            <input name="name"  value="${resume.name}" class="appearance-none border rounded-lg w-7-10 px-3 py-2" type="text" placeholder="이름을 입력해 주세요.">

            <label class="block text-gray-700 text-sm font-bold mb-2" for="name">생년월일</label>
            <input  name="birth" value="${resume.birth}" class="appearance-none border rounded-lg w-3-10 px-3 py-2" type="text" placeholder="이름을 입력해 주세요.">
          </div>
          <div class="mb-4">
      ...
      <div class="flex flex-wrap mb-4">
        ...
        <div class="w-full md:w-1/2 px-2">
          ...
          <input name="certification" value="${resume.certification}" class="appearance-none border rounded-lg w-full px-3 py-2" type="text" >
            ...
            <!-- Education -->
            <div class="container mx-auto p-6 bg-white shadow-md rounded-lg mt-10 container-fixed div_line_none">
                <header class="mb-6">
                  ...
                  <div class="space-y-4" id="education-fields">
                    ...
                    <div class="border rounded-lg p-4 bg-gray-50 relative">
                      <button type="button" class="absolute top-2 right-2 text-gray-500 hover:text-gray-700">&times;</button>
      ...
      <!-- Additional Sections -->
      <!-- Career -->
      <div class="container mx-auto p-6 bg-white shadow-md rounded-lg mt-10 div_line_none">
        <header class="mb-6">
    ...
    <div class="container mx-auto p-6 bg-white shadow-md rounded-lg mt-10 div_line_none">
      ...
      <div class="container mx-auto p-6 bg-white shadow-md rounded-lg mt-10 div_line_none">
        <header class="mb-6">
          ...
          <div class="space-y-4">
            <!-- URL Entry -->
            <div class="border rounded-lg p-4 bg-gray-50 relative" id="url-section">
            ...
            <div class="border rounded-lg p-4 bg-gray-50 relative" id="file-section">
              ...
              <button type="button" class="text-blue-500 w-full py-2 mb-4 border border-blue-500 rounded-lg" onclick="addFileField()">+ 파일 추가</button>
		        <div class="flex items-center mb-4">
		          <input name="portfolioFileName" value="${resume.portfolio.portfolioFile}" class="appearance-none border rounded-l-lg w-full px-3 py-2" type="file" onchange="this.nextElementSibling.value = this.value">
